...
const EnhancedAboutPage = () => {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-2 sm:p-4">
            <Card className={`w-[calc(100vw-2rem)] h-full sm:w-[calc(100vw-4rem)] sm:h-[calc(100vh-4rem)] lg:w-[calc(100vw-6rem)] lg:h-[calc(100vh-6rem)]
           max-w-7xl bg-zinc-900 text-white p-6 sm:p-10 lg:p-14 border-none
...
// return (
//     <div className="min-h-screen bg-black flex items-center justify-center p-2 sm:p-4">
//         <Card className={`  w-[calc(100vw-2rem)] h-[calc(100vh-2rem)] sm:w-[calc(100vw-4rem)] sm:h-[calc(100vh-4rem)] lg:w-[calc(100vw-6rem)] lg:h-[calc(100vh-6rem)]
//        max-w-7xl bg-zinc-900 text-white p-6 sm:p-10 lg:p-14 border-none
...
//                 <div className="relative group flex-shrink-0">
//                     <div className="absolute -inset-1 bg-gradient-to-r from-gray-600 to-gray-400 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-300"></div>
//                     <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-3xl bg-gradient-to-br from-blue-500 to-purple-600 border-2 border-gray-500 transition-all duration-300 group-hover:scale-105 group-hover:border-white flex items-center justify-center">
...
//                 {/* Dynamic Content */}
//                 <div className="lg:col-span-2 flex-1 min-h-0 overflow-hidden pr-2 space-y-4">
//                     {activeSection === 'intro' && (
...
//                                 <h3 className="text-white text-lg font-semibold">Things I Love</h3>
//                             </div>
//                             <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 px-3 py-2">
//                                 {hobbies.map((hobby, index) => (
//                                     <div key={index} className="bg-zinc-800 p-3 rounded-lg hover:bg-gray-500 transition-all duration-300 hover:scale-105 group">
//                                         <div className="flex items-center gap-3 mb-2">
//                                             <span className="text-lg group-hover:scale-110 transition-transform duration-300">{hobby.icon}</span>
...
//                     {activeSection === 'achievements' && (
//                         <div className="space-y-3 animate-fade-in h-full overflow-y-auto pr-2 custom-scrollbar">
//                             <div className="flex items-center gap-2 mb-4">
//                                 <Trophy className="w-5 h-5 text-yellow-400" />
//                                 <h3 className="text-white text-lg font-semibold">Achievements & Milestones</h3>
//                             </div>
